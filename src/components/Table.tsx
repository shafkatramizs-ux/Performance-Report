      ...
      <>
        {superTitle && (
          <tr>
            ...
            <th colSpan={columns.length + (showGrowth ? 2 : 0)} className="bg-[#1e2a5e] text-white py-1 px-2 text-center text-[10px] sm:text-xs font-semibold border border-[#1e2a5e] uppercase tracking-wider">
              {superTitle}
            </th>
          </tr>
        )}
        <tr>
          <th className="bg-[#1e2a5e] text-white py-1.5 px-2 text-left text-xs sm:text-sm font-semibold border border-[#1e2a5e]">
            {title}
          </th>
          {columns.map((col) => {
            ...
            return (
              <th
                key={col}
                className={clsx(
                  "py-1.5 px-1 text-center text-[10px] sm:text-xs font-semibold border",
          ...
          {showGrowth && (
            <>
              <th className="bg-gray-50 text-gray-800 py-1.5 px-1 text-center text-[10px] sm:text-xs font-semibold border border-gray-200">MoM Growth</th>
              <th className="bg-gray-50 text-gray-800 py-1.5 px-1 text-center text-[10px] sm:text-xs font-semibold border border-gray-200">YoY Growth</th>
            </>
          )}
        </tr>
      </>
